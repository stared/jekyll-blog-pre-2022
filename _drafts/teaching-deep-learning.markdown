...
[^quantum]: If your background is in quantum information, the only thing you need to change is C to R. And expect less tensor structure, and more - convolutions.
